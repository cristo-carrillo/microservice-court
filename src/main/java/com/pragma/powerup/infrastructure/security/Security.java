...
public class Security {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .antMatchers("/api/v1/authentication/**", "/swagger-ui/**", "/swagger-resources/**", "/api/v1/user/client/**", "/v3/api-docs/**",
                        "/v2/api-docs/**")
                .permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/api/v1/plate/**","/api/v1/employee/**").hasAuthority("ROLE_Propietario")
                .antMatchers(HttpMethod.PUT,"/api/v1/plate/**","/api/v1/employee/**").hasAuthority("ROLE_Propietario")
                .antMatchers(HttpMethod.GET,"/api/v1/plate/**").hasAuthority("ROLE_Cliente")
